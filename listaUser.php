...
<body>
                ...
                <form>
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope="col">
                                    <div class="input-group">
                                        <input type="text" name="buscarUser" class="form-control" placeholder="Por user" value="<?php echo isset($_GET['buscarUser']) ? $_GET['buscarUser'] : ''; ?>">
                                ...
                                <th scope="col">
                                    <a href="crearUser.php" class="btn btn-secondary">
                            ...
                            <tr>
                                ...
                                <?php
                                    ...
                                    ?>
                                <?php ordenador($columna,'user',$tipo); ?>
                                </th>
                        ...
                        <tbody>
                            ...
                            while ($row = mysqli_fetch_array($resultSet, MYSQLI_ASSOC)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="editarUser.php?id=<?php echo $row['id'] ?>"><i class="fa fa-edit mr-2"></i></a>
                                        <a href="listaUser.php?idBorrar=<?php echo $row['id'] ?>" class="borrar"><i class="fa fa-trash text-danger"></i></a>
                                    </td>
                                </tr>
                            <?php
                            }
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination">
                            ...
                            <li class="page-item"><a class="page-link" href="listaUser.php?pagina=<?php echo ($paginaSeleccionada-1) ?>">Previous</a></li>
                            <?php endif; ?>

                            <?php for($i=1;$i<=$totalPaginas;$i++): $activo=($paginaSeleccionada==$i)?" active ":" "; ?>
                                <li class="page-item <?php echo $activo; ?>"><a class="page-link" href="listaUser.php?pagina=<?php echo $i ?>"><?php echo $i ?></a></li>
                            <?php endfor; ?>

                            <?php if($paginaSeleccionada!=$totalPaginas): ?>
                                <li class="page-item"><a class="page-link" href="listaUser.php?pagina=<?php echo ($paginaSeleccionada+1) ?>">Next</a></li>
                            <?php endif; ?>
                        </ul>
                    </nav>
                    <?php endif; ?>
    ...
    function ordenador($columnaSeleccionada,$columnaValor,$tipoOrdenamiento)
    {
        ...
        <div class="float-right">
            ...
            <?php else : ?>
                <a href="listaUser.php?columna=<?php echo $columnaValor; ?>&tipo=asc"><i class="fa fa-arrow-up"></i></a>
            <?php endif; ?>
            ...
            <?php else : ?>
                <a href="listaUser.php?columna=<?php echo $columnaValor; ?>&tipo=desc"><i class="fa fa-arrow-down"></i></a>
            <?php endif; ?>
        </div>
