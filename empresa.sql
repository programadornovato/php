...
CREATE TABLE `productos` (
  ...
  `foto` varchar(90) NOT NULL DEFAULT ''
...
INSERT INTO `productos` (`id`, `nombre`, `precioCompra`, `precioVenta`, `fechaCompra`, `categoria`, `unidadesEnExistencia`, `foto`) VALUES
...
(4, 'Especias Cajun del chef Anton', '22.00', '24.200', '2015-10-13', 'Condimentos', 53, 'virusgallego.jpg'),
(5, 'Mezcla Gumbo del chef Anton', '21.35', '23.485', '2015-10-14', 'Condimentos', 0, ''),
(6, 'Mermelada de grosellas de la abuela', '25.00', '27.500', '2015-10-15', 'Condimentos', 120, 'noMeBorres.php'),
